...
class SendMail extends Component {
  ...
  deleteTemplate(template){
    var self = this;
    var url = '../../../email/deleteItem/' + template._id;
  ...
  retrieveTemplatesNoE(){
    ...
    var self = this;
      axios.post('../../../email/retrievetemplates')
        .then((response)=>{
            var arryAll = [];
            var tempObj = {};
    ...
    req.end((err,response)=>{
        ...
        var self = this;
         self.setState({
              ...
              img.src="../../../upload/getsinglefile/"+files[0].name;
              setTimeout(()=>{
                self.setState({
                  imgFromFile:false
                })
